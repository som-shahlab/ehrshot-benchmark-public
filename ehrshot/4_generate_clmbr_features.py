...
from ehrshot.utils import get_rel_path, convert_csv_labels_to_meds
...
if __name__ == "__main__":
    ...
    # Generate features
    results: Dict[str, Any] = femr.models.transformer.compute_features(dataset, model_name, labels, ontology=ontology, num_proc=num_threads, tokens_per_batch=1024, device=device)
